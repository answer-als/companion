...
namespace Companion
{
    public partial class SpeechBreathAhView : ContentView
    {
...
//                    await Navigation.PopAsync();
        ...
        public async Task PutRecordingToServer()
        {
            ...
            var uri = new Uri(string.Format(CompanionServer.recording_url + App.UserID + "/AhTask", string.Empty));
